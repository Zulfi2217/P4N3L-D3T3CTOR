@shift /0
󾊍@echo off
title  Brother's Corporation - [%date%]
@echo off
mode 90,20
title 
...
@echo  [31m[Detecting] [34m » [97mLoading 10%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 20%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 30%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 40%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 50%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 60%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 70%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 80%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 90%  - Brother's Corporation
timeout 1 > NUL
@echo  [31m[Detecting] [34m » [97mLoading 100% - Brother's Corporation
...
@echo off
mode 90,20
title Brother's Corporation - Zulfiqar Chowdhury#1118
color 4
chcp 65001>nul
echo.
echo.██████╗  █████╗ ███╗   ██╗███████╗██╗         ██╗  ██╗██████╗ 
